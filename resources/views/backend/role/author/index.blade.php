                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form method="POST" action="{{ route('author.edits', $result->id) }}">
                                        @csrf
                                        @method('get')
                                        <button type="submit" class="mr-2 btn-icon btn-icon-only btn btn-outline-warning">Make Seller</button>
                                    </form>
                                    &nbsp;
                                    <form method="POST" action="{{ route('author.update', $result->id) }}">
                                        @csrf
                                        @method('patch')
                                        <button type="submit" class="mr-2 btn-icon btn-icon-only btn btn-outline-warning">Make User</button>
                                    </form>
                                    &nbsp;
