    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Edit Category
                    <div class="page-title-subheading">Silahkan Edit Kategori Untuk Postingan
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-6">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title mb-5">Edit Category</h5>
                    <form method="POST" action="{{ route('category.update', $categories->id) }}">
                        ...
                        <a href="{{ route('category.index') }}" class="mt-1 btn btn-danger btn-block">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
