...
<div class="container">
    <p class="stext-111 cl2 text-center mb-5 text-danger">
        <b>Perlu Diketahui, Transaksi Yang Menunda Pembayaran Selama Terhitung 7 Hari Setelah Checkout Akan Otomatis Dihapus Dari Daftar Checkout.</b>
    </p>
                ...
                <div class="wrap-table-shopping-cart">
                    <table class="table-shopping-cart">
                        ...
                        <tr class="table_row">
                            ...
                            <td class="text-center">
                                <a href="{{ route('paymentdetail', $order->id) }}" class="btn btn-outline-dark"><i class="fa fa-info"> </i></a>
                            </td>
                        </tr>
                    </table>
                </div>
