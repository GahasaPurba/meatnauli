            ...
            <div class="col-md-4 col-lg-3 p-b-80">
                <div class="side-menu">
                    ...
                    <div class="stext-103 bor17 of-hidden pos-relative mb-3">
                        <a href="{{ route('post.create') }}" class="btn btn-block btn-dark">Buat Post</a>
                    </div>
                    @endif
                    <div class="bor17 of-hidden pos-relative">
                        <form method="GET" action="{{ route('blogsearch') }}">
                            @csrf
                            <input type="text" name="search" id="search" class="stext-103 cl2 plh4 size-116 p-l-28 p-r-55" placeholder="Cari Judul Postingan" value="{{ old('search') }}">
