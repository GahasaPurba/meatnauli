@php
$response = \Illuminate\Support\Facades\Http::get('https://v1.nocodeapi.com/meatnauli/instagram/KCQmxttPyYBBZByt');
        ...
        <div class="sidebar flex-col-l p-t-22 p-b-25">
            ...
            <div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
                ...
                <ul class="sidebar-link w-full">
                    ...
                    <li class="p-b-13">
                        <a href="{{ route('post.create') }}" class="stext-102 cl2 hov-cl1 trans-04">
                            Buat Post di Blog
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="p-b-13">
                        <a href="{{ route('item.create') }}" class="stext-102 cl2 hov-cl1 trans-04">
                    ...
                    @if (Auth::check())
                    <li class="p-b-13">
                        <a href="{{ route('question.create') }}" class="stext-102 cl2 hov-cl1 trans-04">
                            Ajukan Pertanyaan di Forum Tanya Jawab
                        </a>
                    </li>
                    <li class="p-b-13">
                        <a href="{{ route('editprofile.edit', Auth::user()->id) }}" class="stext-102 cl2 hov-cl1 trans-04">
                            Edit Profile
                        </a>
                    </li>
                    @endif
            ...
            <div class="header-cart-content flex-w js-pscroll">
                ...
                <div class="w-full">
                    ...
                    <div class="header-cart-buttons flex-w w-full">
                        <a href="{{ route('souvenir.shoppingcart') }}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
                            Lihat Detail
                        </a>
                    </div>
                    @else
