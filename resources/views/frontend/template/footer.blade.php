    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                _Hasync.push(['Histats.start', '1,4462378,4,429,112,75,00011011']);
                ...
                <noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?4462378&101" alt="free tracking" border="0"></a></noscript>
                <!-- Histats.com  END  -->
            </div>
            --}}
            <div class="col-sm-6 col-lg-3 p-b-50">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="{{ route('berbelanja') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            Cara Berbelanja
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="{{ route('berjualan') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            Cara Berjualan
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="{{ route('menambahpostingan') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            Cara Menambahkan Postingan
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="{{ route('mengajukanpertanyaan') }}" class="stext-107 cl7 hov-cl1 trans-04">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <div class="p-t-27">
                    <button class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-03">
                        <a href="{{ route('questionnaire.create') }}" class="cl0 hov-btn2">Isi Kuesioner</a>
                    </button>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 p-b-50">
