...
<div class="app-main__inner">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Latest Posts
                    <div class="btn-actions-pane-right">
                        <div role="group" class="btn-group-sm btn-group">
                            <a href="{{ route('post.index') }}" class="btn btn-focus text-white">View All</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Latest Items
                    <div class="btn-actions-pane-right">
                        <div role="group" class="btn-group-sm btn-group">
                            <a href="{{ route('item.index') }}" class="btn btn-focus text-white">View All</a>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Latest Questions
                    <div class="btn-actions-pane-right">
                        <div role="group" class="btn-group-sm btn-group">
                            <a href="{{ route('question.index') }}" class="btn btn-focus text-white">View All</a>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Asked At</th>
                                <th class="text-center">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
